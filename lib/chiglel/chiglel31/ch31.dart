...
class CH31 extends StatefulWidget {
  const CH31({super.key});

  @override
  State<CH31> createState() => _CH31State();
}

class _CH31State extends State<CH31> {
  int currentTab = 0;
  ...
  Widget currentScreen = const CH3111();
