...
const String api_url = "http://192.168.1.102/dashboard/myfolder/buudalawah.php";
const String json_api_url = "https://jsonplaceholder.typicode.com/users/";
const String manage_chiglel =
    "http://192.168.1.102/dashboard/myfolder/managechiglel.php";
const String ch1 = "http://192.168.1.102/dashboard/myfolder/dundiinawah.php";
const String ch2 = "http://192.168.1.102/dashboard/myfolder/ch2awah.php";
const String t2 = "http://192.168.1.102/dashboard/myfolder/t2awah.php";
...
class Secrets {
  ...
  static const API_KEY = 'AIzaSyAny1HN3RWSnIT_4qTJl9y_-re38mrGXMQ';
}
